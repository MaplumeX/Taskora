...
/**
 * Left slide-in drawer built on Radix Dialog primitives (same a11y,
 * focus-trap and ESC handling as the modal dialog). Used for the
 * Assistant conversation list — summoned on demand instead of occupying a
 * permanent column.
 */
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('px-4 pb-2 pt-4 text-sm font-medium text-muted-foreground', className)}
    {...props}
  />
));
