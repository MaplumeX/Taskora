...
//!
//! webview 中的 Engine（`packages/mobile/src/engine/tauri-storage.ts`）
//! 通过 IPC 命令在这条连接上执行 SQL（command 签名与 desktop 的一致，
//! bundled rusqlite 交叉编译 Android NDK，android-app issue 02）：
