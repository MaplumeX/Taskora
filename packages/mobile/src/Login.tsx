...
/**
 * Mobile login screen — same JWT flow as web/desktop, but the token is
 * persisted through the Android Keystore-encrypted store (ADR-0009, via
 * the injected TokenStore in @taskora/api). Mirrors the desktop login.
 */
